...
abstract class DataPlayer
{
    ...
    {
        get => _countCrimeLevel;
        set
        {
            if (_countCrimeLevel != value)
            {
                _countCrimeLevel = value;
...
class CrimeLevel : DataPlayer
{
    public CrimeLevel(string titleData)
        : base(titleData)
    {
    }
}
