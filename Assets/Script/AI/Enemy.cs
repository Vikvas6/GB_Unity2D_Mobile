...
class Enemy : IEnemy
{
    ...
    public int Power
    {
        get
        {
            ...
            var additinalEnemyPower = KPower * Mathf.Sin(_healthPlayer * _moneyPlayer);
            if (_healthPlayer > MaxHealthPlayer) additinalEnemyPower *= KCoins;
            var power = (int) (_powerPlayer + additinalEnemyPower); 
